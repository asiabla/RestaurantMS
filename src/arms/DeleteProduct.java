...
public class DeleteProduct extends javax.swing.JFrame {
     ...
     */
    public DeleteProduct(int UserLogin, String order, int hall, String table, int reservation) {
    ...
    private void initComponents() {
        ...
        jLabel22.setText("Click on product you want to delete");

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel23.setText("Choose amount of deleted product ");
        ...
        jLabel163.setText("DELETE PRODUCT");
    ...
    private void jSpinner1StateChanged(javax.swing.event.ChangeEvent evt) {                                       
        ...
        if(jSpinner1Value>quantity) {
            PopUp frm = new PopUp("Introduced number is too big");
            frm.setLocationRelativeTo(null);
            frm.setVisible(true);
        }
    }                                      
    ...
    private void TableClicked(java.awt.event.MouseEvent evt) {
        ...
        productID = Integer.valueOf(pom);
        pom = model.getValueAt(selectedRowIndex, 2).toString();
        quantity = Integer.valueOf(pom);

        jSpinner1.setVisible(true);
        jLabel23.setVisible(true);
    }

    private void DeleteProductFinally(java.awt.event.MouseEvent evt) {                                       
        Integer jSpinner1Value = (Integer) jSpinner1.getValue();
        updateDB(jSpinner1Value);

        Order newwindow = new Order(UserLogin, order, hall, table, reservation);
        newwindow.setVisible(true);
        this.setVisible(false);
        PopUp frm = new PopUp("Product has been deleted.");
        frm.setLocationRelativeTo(null);
        frm.setVisible(true);

    }                                      

    private void updateDB(int deletedValue)
    {
        Connection conn = null;
        PreparedStatement stmt = null;
        try {
            conn = ConnectionConfiguration.getConnection();
            String sql = "update order_product set quantity=? where productsID=?";
            stmt = conn.prepareStatement(sql);
            int newValue = quantity-deletedValue;
    ...
    private int quantity=0, productID=0;
