...
public class RemoveOrder extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RemoveOrder
     */
    public RemoveOrder(int UserLogin, String order, int reservation) {
    ...
    private void initComponents() {
        ...
        jLabel29.setText("Are you sure you want to remove order ");
        ...
        jLabel163.setText("REMOVE ORDER");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGap(98, 98, 98)
                        .addComponent(jLabel29, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void removeOrderFromDB()
    {
        ...
        try {
            ...
            String sql = "DELETE FROM orders WHERE IDorder="+order;
    ...
    private void removeOrderProductsFromDB()
    {
        Connection conn = null;
        Statement stmt = null;
        try {
            conn = ConnectionConfiguration.getConnection();
            stmt = conn.createStatement();
            String sql = "DELETE FROM order_product WHERE OrderID="+order;
            stmt.executeUpdate(sql);
        }
        catch(SQLException se)  { se.printStackTrace();}
        catch (Exception e) { e.printStackTrace(); }
    ...
    private void Remove(java.awt.event.MouseEvent evt) {                                       
        removeOrderProductsFromDB();;
        removeOrderFromDB();

        AfterLogin newwindow = new AfterLogin(UserLogin);
        newwindow.setVisible(true);
        this.setVisible(false);
        PopUp frm = new PopUp("Order has been removed.");
