...
public class MakeInventory extends javax.swing.JFrame {

    /**
     * Creates new form MakeInventory
     */
    public MakeInventory(int UserLogin) {
    ...
    private void updateTable()
    {
        ...
        try {
            ...
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Sale");
            ...
            {
                pom = jTable1.getValueAt(i,3).toString();
                price = Float.valueOf(pom);
                pom = jTable1.getValueAt(i,6).toString();
                changeinstock = Integer.valueOf(pom);
                changeinstock=changeinstock*(-1);
                sold = price * changeinstock;
                jTable1.setValueAt(sold,i,1);
            }
            rs.close();
        }
